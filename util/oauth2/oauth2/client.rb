...
module OAuth2
  ...
  class Client # rubocop:disable Metrics/ClassLength
    ...
    def initialize(client_id, client_secret, options = {}, &block)
      ...
      ssl = opts.delete(:ssl)
      if opts[:extract_access_token]
        warn('OAuth2::Client#initialize argument `extract_access_token` will be removed in oauth2 v3. Refactor to use `access_token_class`.')
      end
      @options = {
    ...
    def get_token(params, access_token_opts = {}, extract_access_token = nil, &block)
      if extract_access_token
        warn('OAuth2::Client#get_token argument `extract_access_token` will be removed in oauth2 v3. Refactor to use `access_token_class` on #initialize.')
      end
